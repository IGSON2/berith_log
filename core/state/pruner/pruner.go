...
import (
	...
	"github.com/BerithFoundation/berith-chain/core/state/snapshot"
...
func NewPruner(db berithdb.Database, datadir, trieCachePath string, bloomSize uint64) (*Pruner, error) {
...
func prune(snaptree *snapshot.Tree, root common.Hash, maindb berithdb.Database, stateBloom *stateBloom, bloomPath string, middleStateRoots map[common.Hash]struct{}, start time.Time) error {
...
// in the disk.
func RecoverPruning(datadir string, db berithdb.Database, trieCachePath string) error {
...
func extractGenesis(db berithdb.Database, stateBloom *stateBloom) error {
