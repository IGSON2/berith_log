...
func wipeSnapshot(db berithdb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db berithdb.KeyValueStore) error {
...
func wipeKeyRange(db berithdb.KeyValueStore, kind string, prefix []byte, origin []byte, limit []byte, keylen int, meter metrics.Meter, report bool) error {
