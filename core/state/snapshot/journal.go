...
func loadAndParseJournal(db berithdb.KeyValueStore, base *diskLayer) (snapshot, journalGenerator, error) {
...
func loadSnapshot(diskdb berithdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, recovery bool) (snapshot, bool, error) {
