...
func NewTable(db berithdb.Database, prefix string) berithdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) berithdb.Iterator {
...
func (t *table) NewBatch() berithdb.Batch {
...
func (b *tableBatch) Replay(w berithdb.KeyValueWriter) error {
