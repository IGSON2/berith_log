...
import (
	...
	"github.com/BerithFoundation/berith-chain/berithdb/leveldb"
	"github.com/BerithFoundation/berith-chain/berithdb/memorydb"
...
type freezerdb struct {
	berithdb.KeyValueStore
	berithdb.AncientStore
}
...
func NewDatabase(db berithdb.KeyValueStore) berithdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db berithdb.KeyValueStore, freezer string, namespace string, readonly bool) (berithdb.Database, error) {
...
func NewMemoryDatabase() berithdb.Database {
...
func NewMemoryDatabaseWithCap(size int) berithdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string, readonly bool) (berithdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string, readonly bool) (berithdb.Database, error) {
...
func InspectDatabase(db berithdb.Database, keyPrefix, keyStart []byte) error {
