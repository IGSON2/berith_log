...
type (
	...
	UpdateHeadBlocksCallback func(berithdb.KeyValueWriter, *types.Header) (uint64, bool)

	// DeleteBlockContentCallback is a callback function that is called by SetHead
	// before each header is deleted.
	DeleteBlockContentCallback func(berithdb.KeyValueWriter, common.Hash, uint64)
)
