...
func (tx *Transaction) Base() JobWallet   { return tx.inner.base() }   //[Berith] Tx JobWallet Base
func (tx *Transaction) Target() JobWallet { return tx.inner.target() } //[Berith] Tx JobWallet Target
...
func NewMessageWithJobWallet(from common.Address, to *common.Address, nonce uint64, amount *big.Int, gasLimit uint64, gasPrice *big.Int, data []byte, accessList AccessList, checkNonce bool, base JobWallet, target JobWallet) Message {
	return Message{
		from:       from,
		to:         to,
		nonce:      nonce,
