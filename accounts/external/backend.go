...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain berith_chain.ChainStateReader) {
...
func (api *ExternalSigner) SignData(account accounts.Account, mimeType string, data []byte) ([]byte, error) {
	...
	if mimeType == accounts.MimetypeClique || mimeType == accounts.MimetypeBsrr && (res[64] == 27 || res[64] == 28) {
