...
type NodeIterator interface {
	...
	AddResolver(berithdb.KeyValueStore)
}
...
type nodeIterator struct {
	...
	resolver berithdb.KeyValueStore // Optional intermediate resolver above the disk layer
}
...
func (it *nodeIterator) AddResolver(resolver berithdb.KeyValueStore) {
...
func (it *differenceIterator) AddResolver(resolver berithdb.KeyValueStore) {
...
func (it *unionIterator) AddResolver(resolver berithdb.KeyValueStore) {
	panic("not implemented")
}
