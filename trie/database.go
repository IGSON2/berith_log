...
type Database struct {
	diskdb berithdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb berithdb.KeyValueStore) *Database {
...
func NewDatabaseWithConfig(diskdb berithdb.KeyValueStore, config *Config) *Database {
...
func (db *Database) DiskDB() berithdb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch berithdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
