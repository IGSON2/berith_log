...
func (s *spongeDb) NewBatch() berithdb.Batch                 { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) berithdb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w berithdb.KeyValueWriter) error { return nil }
