...
import (
	...
	"github.com/BerithFoundation/berith-chain/les/utils"
	...
	"github.com/BerithFoundation/berith-chain/p2p/nodestate"
...
func NewServerPool(db berithdb.KeyValueStore, dbKey []byte, mixTimeout time.Duration, query QueryFunc, clock mclock.Clock, trustedURLs []string, requestList []RequestInfo) (*ServerPool, enode.Iterator) {
	s := &ServerPool{
		db:           db,
		clock:        clock,
