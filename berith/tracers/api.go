...
import (
	...
	"github.com/BerithFoundation/berith-chain/internals/berithapi"
...
type TraceCallConfig struct {
	*vm.LogConfig
	...
	Timeout        *string
	Reexec         *uint64
	StateOverrides *berithapi.StateOverride
}
...
func (api *API) TraceCall(ctx context.Context, args berithapi.CallArgs, blockNrOrHash rpc.BlockNumberOrHash, config *TraceCallConfig) (interface{}, error) {
