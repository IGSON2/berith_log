...
func (db *Database) NewBatch() berithdb.Batch {
	return &batch{
		db: db.db,
		b:  new(leveldb.Batch),
	}
...
func (db *Database) NewIterator(prefix []byte, start []byte) berithdb.Iterator {
...
func (b *batch) Replay(w berithdb.KeyValueWriter) error {
	return b.b.Replay(&replayer{writer: w})
}

// replayer is a small wrapper to implement the correct replay methods.
type replayer struct {
	writer  berithdb.KeyValueWriter
	failure error
}
